...
static const char * const fsa4480_micbias_texts[] = {
	"enable",
	"disable",
};

static SOC_ENUM_SINGLE_EXT_DECL(fsa4480_micbias_enum, fsa4480_micbias_texts);
...
SOC_SINGLE_EXT("Get DSP3 State", SND_SOC_NOPM, 2, 1, 0, cs47l35_get_dsp_state,
	       cs47l35_put_dsp_state),
SOC_ENUM_EXT("FSA4480 Demux", fsa4480_micbias_enum,
        fsa4480_micbias_demux_get, fsa4480_micbias_demux_put),
